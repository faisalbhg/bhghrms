                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <h3 class="text-center mb-4">Rest Password</h3>
                                    ...
                                    <?php endif; ?>
                                    <?= form_open('change-password/'.$value,array("autocomplete"=>"off")); ?>
                                        <?= csrf_field() ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group transparent-append">
                                                <span class="input-group-text"> <i class="fa fa-lock"></i> </span>
                                                <input type="password" class="form-control" id="confirm-password" name="password_confirm" placeholder="Choose a safe one.." required="">
                                                <span class="input-group-text show-pass"> 
                                                    <i class="fa fa-eye-slash"></i>
                                                    <i class="fa fa-eye"></i>
                                                </span>
