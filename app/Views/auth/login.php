...
<body class="vh-100">
    <div class="authincation h-100" style="background-image:url('<?=base_url('assets/images/hrmlogibg.png');?>'); background-size:cover; background-position: 100%; background-repeat: no-repeat;">
                                    ...
                                    <?= form_open('login',array("autocomplete"=>"off")); ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="validationCustomUsername" placeholder="Enter a username.." required=""  value="<?= set_value('username'); ?>" name="username">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group transparent-append">
                                                ...
                                                <input type="password" class="form-control" id="dlab-password" name="password" placeholder="Confirm Password.." required="">
