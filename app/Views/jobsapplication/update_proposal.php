							...
							<div class="card-body">
                                ...
                                <div class="basic-form">
                                  ...
                                  <div class="mb-3 row">
                                      ...
                                      <div class="col-sm-4">
                                          <input type="number" class="form-control wizard-required" id="homeRentAllownace" name="homeRentAllownace"  value="<?=$applicantDetails['homeRentAllow'];?>">
                                          <?php 
																					...
																					?>
																					<div class="form-check checkbox-danger">
                                              <input class="form-check-input" type="checkbox" name="companyAccomodation" id="companyAccomodation" <?php if($applicantDetails['companyAccomodation']!=null){ ?>checked<?php } ?> value="1">
                                              <label class="form-check-label">Company Accommodation </label>
                                          </div>
                                  ...
                                  <div class="mb-3 row">
                                      ...
                                      <div class="col-sm-4">
                                          <input type="number" class="form-control wizard-required" id="transportAllownace" name="transportAllownace" value="<?=$applicantDetails['transportAllow'];?>">
                                          <?php 
																					...
																					?>
																					<div class="form-check checkbox-danger">
                                              <input class="form-check-input" type="checkbox" name="companyTransport" id="companyTransport" <?php if($applicantDetails['companyTransport']!= null){ ?>checked<?php } ?> value="1">
                                              <label class="form-check-label">Company Transportation</label>
                                          </div>
                                      </div>
                                  </div>
                                  <div class="mb-3 row">
                                      ...
                                      <div class="col-sm-4">
                                          <input type="number" class="form-control" id="mobileAllowance" name="mobileAllowance"   value="<?=$applicantDetails['mobileAllowPerc'];?>">
                                          <?php 
                                  ...
                                  <div class="mb-3 row">
                                      <label class="col-sm-3 col-form-label">Fuel Allowance</label>
                                      <div class="col-sm-4">
                                        <input type="number" class="form-control wizard-required" id="fuelAllowance" name="fuelAllowance" value="<?=$applicantDetails['fuelAllow'];?>">
                                        <?php 
																				...
																				?>
																				<div class="form-check checkbox-danger">
                                          <input class="form-check-input" type="checkbox" name="companyFuel" id="companyFuel" <?php if($applicantDetails['fuelFixed']==false){ ?>checked<?php } ?> value="1">
                                          <label class="form-check-label">Company Fuel</label>
                                        </div>
                                      </div>
                                  </div>
                                  <div class="mb-3 row">
                                      <label class="col-sm-3 col-form-label">Food Allowance</label>
                                      <div class="col-sm-4">
                                        <input type="number" class="form-control wizard-required" id="foodAllowance" name="foodAllowance" value="<?=$applicantDetails['foodAllow'];?>">
                                        <?php 
																				...
																				?>
																				<div class="form-check checkbox-danger">
                                          <input class="form-check-input" type="checkbox" name="companyFood" id="companyFood" <?php if($applicantDetails['foodFixed']==false){ ?>checked<?php } ?> value="1">
                                          <label class="form-check-label">Company Food</label>
                                        </div>
                                      </div>
                                  </div>
                                  <div class="mb-3 row">
                                      <div class="col-sm-3">
	                                      <label class="col-sm-3 col-form-label">Overtime</label>
	                                    </div>
                                      <div class="col-sm-9">
                                          <div class="form-check checkbox-danger">
                                  ...
                                  <div class="mb-3 row">
                                      <div class="col-sm-3">
	                                      <label class="col-sm-3 col-form-label">Company Car</label>
	                                    </div>
                                      <div class="col-sm-9">
                                          <div class="form-check checkbox-danger">
