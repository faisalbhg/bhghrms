        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="d-flex align-items-center mb-4 flex-wrap">
					<h4 class="fs-20 font-w600 me-auto">Job Proposals</h4>
					<div>
											...
											<td class="action-btn wspace-no">
												<span>
													...
													<div class="dropdown-menu dropdown-menu-right" style="margin: 0px;">
														...
														<?php if($application['proposalStatus']==1)
														{
															?>
															<a class="dropdown-item text-black" href="<?=base_url('job-proposal/'.$application['applicantionId'].'/'.$application['proposalID']);?>" id="<?=$application["applicantionId"];?>nextStep"><i class="fas fa-arrow-right me-1 text-success"></i>Update Proposal</a>
															<?php
														}
														else
														{
															?>
															<a class="dropdown-item text-black" href="<?=base_url('view-proposal/'.$application['proposalID']);?>" ><i class="fas fa-arrow-right me-1 text-success"></i>View Proposal </a>
															<?php
														}
														?>
														</a>
