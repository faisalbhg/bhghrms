    ...
    <ul style='list-style: decimal;margin-top:0px;'>
        ...
        <div style='width:100%;'>
            <table style='width:100%;'>
                ...
                <tr>
                    <td>
                        <p>This document issued electronically in accordance with the provisions of Federal Law No. (1) Of 2006 on Electronic Commerce and Transactions</p>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <li style="margin-bottom:0;"><strong><u>Remunerations:</u></strong>
            <ul style='list-style:lower-alpha;'>
                ...
                <li style="margin-bottom:0;"><strong><u>Transport</u>:</strong><br>
                    <?php
