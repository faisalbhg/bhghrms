...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>BHG HRM::Companies List</title>
        ...
        <div class="content-body">
            <div class="container-fluid">
            	<div class="d-flex align-items-center mb-4 flex-wrap">
					...
					<div>
					<a href="<?=base_url('hrms-new-company');?>" class="btn btn-primary me-3 btn-sm"><i class="fas fa-plus me-2"></i>Add New Company</a>
                                        ...
                                        <tbody>
                                        	...
                                        	foreach($companies as $comKey => $company)
                                        	{
	                                        	...
	                                        	<tr>
	                                                ...
	                                                <td>
														<div class="d-flex">
															<a href="<?=base_url('hrms-update-company/'.$company['companyId']);?>" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
