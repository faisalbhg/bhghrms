...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>BHG HRMS::Create Comapny</title>
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="d-flex align-items-center mb-4 flex-wrap">
					<h4 class="fs-20 font-w600  me-auto">New Company</h4>
					<div>
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="card">
                            ...
                            <?php endif; ?>
                            <?= form_open('hrms-new-company',array("autocomplete"=>"off")); ?>
                                <?= csrf_field() ?>
								<div class="card-body">
									<div class="col-xl-6">
										<div class="row">
											<div class="col-xl-12  col-md-6 mb-4">
												...
												<input type="text" class="form-control" placeholder="Company Name" aria-label="name" name="companyName">
											...
											<div class="col-xl-12 mb-4">
												  ...
												  <textarea id="editor" class="form-control solid" aria-label="With textarea" name="companyAddress" style="height: 200px;"></textarea>
											</div>
										</div>
									</div>
									<!-- <div>
