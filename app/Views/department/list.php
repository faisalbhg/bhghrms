...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>BHG HRM::Departments List</title>
        ...
        <div class="content-body">
            <div class="container-fluid">
            	<div class="d-flex align-items-center mb-4 flex-wrap">
					<h4 class="fs-20 font-w600  me-auto">Departments List</h4>
					<div>
					<a href="<?=base_url('hrms-new-department');?>" class="btn btn-primary me-3 btn-sm"><i class="fas fa-plus me-2"></i>Add New Department</a>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                        	<?php 
                                        	foreach($departments as $dprtKey => $department)
                                        	{
	                                        	?>
	                                        	<tr>
	                                        		<td><?=$dprtKey+1;?></td>
	                                                ...
	                                                <td>
														<div class="d-flex">
															<a href="<?=base_url('hrms-update-department/'.$department['departmentId']);?>" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
