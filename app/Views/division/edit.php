...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>BHG HRMS::Edit <?=$division['divisionName'];?> Division</title>
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="d-flex align-items-center mb-4 flex-wrap">
					<h4 class="fs-20 font-w600  me-auto">Edit <?=$division['divisionName'];?></h4>
					<div>
					<a href="<?=base_url('hrms-divisions');?>" class="btn btn-primary me-3 btn-sm"><i class="fas fa-list me-2"></i>Divisions List</a>
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="card">
                            ...
                            <?php endif; ?>
                            <?= form_open('hrms-update-division/'.$division['divisionId'],array("autocomplete"=>"off")); ?>
                                <?= csrf_field() ?>
								<div class="card-body">
									<div class="col-xl-6">
										<div class="row">
											<div class="col-xl-12  col-md-6 mb-4">
												...
												<select class="form-control" name="companyId">
													...
													{
													?>
													<option <?php if($division['companyId']==$company['companyId']){ ?> selected <?php } ?> value="<?=$company['companyId'];?>"><?=$company['companyName'];?></option>
													<?php
													}
											...
											<div class="col-xl-12  col-md-6 mb-4">
												<label  class="form-label font-w600">Divisions Name<span class="text-danger scale5 ms-2">*</span></label>
												<input type="text" class="form-control" placeholder="Division Name" aria-label="name" name="divisionName" value="<?=$division['divisionName'];?>">
